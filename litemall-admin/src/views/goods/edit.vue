    ...
    <el-card class="box-card">
      ...
      <el-form ref="goods" :rules="rules" :model="goods" label-width="150px">
        ...
        <el-form-item label="商品名称" prop="name">
          <el-input v-model="goods.name" ref="priceComparison_vo_commodityName"/>
        </el-form-item>
        <el-form-item label="商品编号" prop="goodsSn">
          <el-input v-model="goods.goodsSn" ref="priceComparisonCommodityId" />
        </el-form-item>
        ...
        <el-form-item label="所属分类">
          <el-cascader ref="priceComparison_vo_categoryName" v-model="categoryIds" :options="categoryList" clearable expand-trigger="hover" @change="handleCategoryChange" />
        </el-form-item>
