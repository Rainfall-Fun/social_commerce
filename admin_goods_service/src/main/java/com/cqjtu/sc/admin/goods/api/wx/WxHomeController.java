...
import com.cqjtu.sc.admin.goods.service.HomeCacheManager;
import com.cqjtu.sc.admin.goods.service.RecommendService;
...
public class WxHomeController {
    ...
    /**
     * 首页数据
     * @param userInfoId 当用户已经登录时，非空。为登录状态为null
     * @return 首页数据
     */
    @GetMapping("/index")
...
//        Callable<List> newGoodsListCallable = () -> goodsService.queryByNew(0, SystemConfig.getNewLimit());
        ...
        Callable<Object> hotGoodsListCallable = () -> recommendService.getRecommend(userInfoId);
...
//        FutureTask<List> newGoodsListTask = new FutureTask<>(newGoodsListCallable);
        FutureTask<Object> hotGoodsListTask = new FutureTask<>(hotGoodsListCallable);
