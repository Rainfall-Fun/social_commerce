<template>
	<div class="login">
		...
		<div class="store_name">轻量级社交电商</div>
	</div>
    ...
    <md-field-group>
      ...
      <div class="clearfix">
        <div class="float-l">
          <router-link to="/login/registerGetCode">注册</router-link>
        </div>
        <div class="float-r">
      ...
      <div class="text-desc text-center bottom_positon">技术支持: vant</div>
